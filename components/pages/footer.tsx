...
export const Footer = () => {
	return (
		<Container className="p-0 md:max-w-none md:p-0 lg:relative lg:px-8">
			<footer className="relative mt-16 flex w-full flex-col items-center bg-[#EEEFF4] pb-10 pt-24 md:static md:w-[80%] md:flex-row md:gap-10 md:p-0 lg:mt-0 lg:w-[90%] xl:gap-20">
				<Link
					href={Routes.Home}
